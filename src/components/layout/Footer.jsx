...
<li>- 0703313371</li>
            <li>Email: contact@artshouseservicessarl.cm</li>
            
            
            <li className="flex items-center gap-4 pt-2">
              <a href="https://www.facebook.com/search/pages/?q=Douala%20House%20Services&sde=AbrggujvjMyXR74p7wCRmi0L_zu0jmOyUZzf8HGUjsoFR3AgjBZh7C6nMHBmYpwZR4RMZiAkOHyu6RQidk6huyHE" target="_blank" rel="noopener noreferrer" className="p-2 bg-blue-600 text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="Facebook">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://wa.me/237677255037" target="_blank" rel="noopener noreferrer" className="p-2 bg-green-500 text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="WhatsApp">
